#!/bin/bash
# Тестовый скрипт деплоя MAX Bot (исправленный для текущего репозитория)
# Использование: ./deploy-test.sh [branch] [backup]
...
echo "=========================================="
echo "MAX Bot Deployment Script (TEST)"
echo "=========================================="
echo "Branch: $BRANCH"
echo "Backup: $BACKUP"
...
# Обновление кода (используем 'my' вместо 'origin' или текущую ветку)
echo "📥 Обновление кода из ветки $BRANCH..."
# Проверяем, есть ли remote 'origin', если нет - используем 'my'
